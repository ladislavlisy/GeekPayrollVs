...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.TaxBaseAdvanceOrdinarySource;
    ...
    public class TaxBaseAdvanceOrdinaryArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "TaxBaseAdvanceOrdinaryArticle(ARTICLE_TAX_BASE_ADVANCE_ORDINARY, 1018): {0}";

        public TaxBaseAdvanceOrdinaryArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_TAX_BASE_ADVANCE_ORDINARY)
        {
            SourceValues = new TaxBaseAdvanceOrdinarySource();

            InternalEvaluate = TaxBaseAdvanceOrdinaryConcept.EvaluateConcept;
        }
        ...
        public TaxBaseAdvanceOrdinarySource SourceValues { get; set; }
        ...
        {
            TaxBaseAdvanceOrdinaryArticle cloneArticle = (TaxBaseAdvanceOrdinaryArticle)this.MemberwiseClone();
