...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.TaxAdvanceSolidarySource;
    ...
    public class TaxAdvanceSolidaryArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "TaxAdvanceSolidaryArticle(ARTICLE_TAX_ADVANCE_SOLIDARY, 1021): {0}";

        public TaxAdvanceSolidaryArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_TAX_ADVANCE_SOLIDARY)
        {
            SourceValues = new TaxAdvanceSolidarySource();

            InternalEvaluate = TaxAdvanceSolidaryConcept.EvaluateConcept;
        }

        public TaxAdvanceSolidaryArticle(ISourceValues values) : this()
        {
            TaxAdvanceSolidarySource sourceValues = values as TaxAdvanceSolidarySource;

            SourceValues = CloneUtils<TaxAdvanceSolidarySource>.CloneOrNull(sourceValues);
        }
        ...
        public TaxAdvanceSolidarySource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<TaxAdvanceSolidarySource>(values);
        }
        ...
        {
            TaxAdvanceSolidaryArticle cloneArticle = (TaxAdvanceSolidaryArticle)this.MemberwiseClone();
