...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.InsSocialFinalSource;
    ...
    public class InsSocialFinalArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "InsSocialFinalArticle(ARTICLE_INS_SOCIAL_FINAL, 1040): {0}";

        public InsSocialFinalArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_INS_SOCIAL_FINAL)
        {
            SourceValues = new InsSocialFinalSource();

            InternalEvaluate = InsSocialFinalConcept.EvaluateConcept;
        }

        public InsSocialFinalArticle(ISourceValues values) : this()
        {
            InsSocialFinalSource sourceValues = values as InsSocialFinalSource;

            SourceValues = CloneUtils<InsSocialFinalSource>.CloneOrNull(sourceValues);
        }
        ...
        public InsSocialFinalSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<InsSocialFinalSource>(values);
        }
        ...
        {
            InsSocialFinalArticle cloneArticle = (InsSocialFinalArticle)this.MemberwiseClone();
