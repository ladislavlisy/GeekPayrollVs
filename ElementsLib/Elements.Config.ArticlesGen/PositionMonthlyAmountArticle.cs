...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.PositionMonthlyAmountSource;
    ...
    public class PositionMonthlyAmountArticle : GeneralArticle, ICloneable
    {
        ...
        {
            SourceValues = new PositionMonthlyAmountSource();
        ...
        {
            PositionMonthlyAmountSource sourceValues = values as PositionMonthlyAmountSource;

            SourceValues = CloneUtils<PositionMonthlyAmountSource>.CloneOrNull(sourceValues);
        }
        ...
        public PositionMonthlyAmountSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<PositionMonthlyAmountSource>(values);
        }
