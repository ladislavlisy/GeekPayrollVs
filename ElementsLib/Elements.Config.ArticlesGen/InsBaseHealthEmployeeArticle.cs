...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.InsBaseHealthEmployeeSource;
    ...
    public class InsBaseHealthEmployeeArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "InsBaseHealthEmployeeArticle(ARTICLE_INS_BASE_HEALTH_EMPLOYEE, 1036): {0}";

        public InsBaseHealthEmployeeArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_INS_BASE_HEALTH_EMPLOYEE)
        {
            SourceValues = new InsBaseHealthEmployeeSource();

            InternalEvaluate = InsBaseHealthEmployeeConcept.EvaluateConcept;
        }

        public InsBaseHealthEmployeeArticle(ISourceValues values) : this()
        {
            InsBaseHealthEmployeeSource sourceValues = values as InsBaseHealthEmployeeSource;

            SourceValues = CloneUtils<InsBaseHealthEmployeeSource>.CloneOrNull(sourceValues);
        }
        ...
        public InsBaseHealthEmployeeSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<InsBaseHealthEmployeeSource>(values);
        }
        ...
        {
            InsBaseHealthEmployeeArticle cloneArticle = (InsBaseHealthEmployeeArticle)this.MemberwiseClone();
