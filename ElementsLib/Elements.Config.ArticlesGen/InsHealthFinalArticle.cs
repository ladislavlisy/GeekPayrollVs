...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.InsHealthFinalSource;
    ...
    public class InsHealthFinalArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "InsHealthFinalArticle(ARTICLE_INS_HEALTH_FINAL, 1039): {0}";

        public InsHealthFinalArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_INS_HEALTH_FINAL)
        {
            SourceValues = new InsHealthFinalSource();

            InternalEvaluate = InsHealthFinalConcept.EvaluateConcept;
        }

        public InsHealthFinalArticle(ISourceValues values) : this()
        {
            InsHealthFinalSource sourceValues = values as InsHealthFinalSource;

            SourceValues = CloneUtils<InsHealthFinalSource>.CloneOrNull(sourceValues);
        }
        ...
        public InsHealthFinalSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<InsHealthFinalSource>(values);
        }
        ...
        {
            InsHealthFinalArticle cloneArticle = (InsHealthFinalArticle)this.MemberwiseClone();
