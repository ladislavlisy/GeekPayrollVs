...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.InsBaseSocialCompoundSource;
    ...
    public class InsBaseSocialCompoundArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "InsBaseSocialCompoundArticle(ARTICLE_INS_BASE_SOCIAL_COMPOUND, 1038): {0}";

        public InsBaseSocialCompoundArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_INS_BASE_SOCIAL_COMPOUND)
        {
            SourceValues = new InsBaseSocialCompoundSource();

            InternalEvaluate = InsBaseSocialCompoundConcept.EvaluateConcept;
        }

        public InsBaseSocialCompoundArticle(ISourceValues values) : this()
        {
            InsBaseSocialCompoundSource sourceValues = values as InsBaseSocialCompoundSource;

            SourceValues = CloneUtils<InsBaseSocialCompoundSource>.CloneOrNull(sourceValues);
        }
        ...
        public InsBaseSocialCompoundSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<InsBaseSocialCompoundSource>(values);
        }
        ...
        {
            InsBaseSocialCompoundArticle cloneArticle = (InsBaseSocialCompoundArticle)this.MemberwiseClone();
