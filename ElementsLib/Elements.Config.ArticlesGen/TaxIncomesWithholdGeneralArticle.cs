...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.TaxIncomesWithholdGeneralSource;
    ...
    public class TaxIncomesWithholdGeneralArticle : GeneralArticle, ICloneable
    {
        ...
        {
            SourceValues = new TaxIncomesWithholdGeneralSource();
        ...
        {
            TaxIncomesWithholdGeneralSource sourceValues = values as TaxIncomesWithholdGeneralSource;

            SourceValues = CloneUtils<TaxIncomesWithholdGeneralSource>.CloneOrNull(sourceValues);
        }
        ...
        public TaxIncomesWithholdGeneralSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<TaxIncomesWithholdGeneralSource>(values);
        }
