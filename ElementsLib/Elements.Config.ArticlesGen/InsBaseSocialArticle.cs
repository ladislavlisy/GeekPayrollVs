...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.InsBaseSocialSource;
    ...
    public class InsBaseSocialArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "InsBaseSocialArticle(ARTICLE_INS_BASE_SOCIAL, 1037): {0}";

        public InsBaseSocialArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_INS_BASE_SOCIAL)
        {
            SourceValues = new InsBaseSocialSource();

            InternalEvaluate = InsBaseSocialConcept.EvaluateConcept;
        }
        ...
        public InsBaseSocialSource SourceValues { get; set; }
        ...
        {
            InsBaseSocialArticle cloneArticle = (InsBaseSocialArticle)this.MemberwiseClone();
