...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.InsBaseHealthSource;
    ...
    public class InsBaseHealthArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "InsBaseHealthArticle(ARTICLE_INS_BASE_HEALTH, 1035): {0}";

        public InsBaseHealthArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_INS_BASE_HEALTH)
        {
            SourceValues = new InsBaseHealthSource();

            InternalEvaluate = InsBaseHealthConcept.EvaluateConcept;
        }

        public InsBaseHealthArticle(ISourceValues values) : this()
        {
            InsBaseHealthSource sourceValues = values as InsBaseHealthSource;

            SourceValues = CloneUtils<InsBaseHealthSource>.CloneOrNull(sourceValues);
        }
        ...
        public InsBaseHealthSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<InsBaseHealthSource>(values);
        }
        ...
        {
            InsBaseHealthArticle cloneArticle = (InsBaseHealthArticle)this.MemberwiseClone();
