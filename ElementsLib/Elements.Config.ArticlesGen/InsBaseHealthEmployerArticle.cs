...
namespace ElementsLib.Elements.Config.Articles
{
    ...
    using SourceItem = Sources.InsBaseHealthEmployerSource;
    ...
    public class InsBaseHealthEmployerArticle : GeneralArticle, ICloneable
    {
        ...
        public static string ARTICLE_DESCRIPTION_ERROR_FORMAT = "InsBaseHealthEmployerArticle(ARTICLE_INS_BASE_HEALTH_EMPLOYER, 1037): {0}";

        public InsBaseHealthEmployerArticle() : base((ConfigRole)ConfigRoleEnum.ARTICLE_INS_BASE_HEALTH_EMPLOYER)
        {
            SourceValues = new InsBaseHealthEmployerSource();

            InternalEvaluate = InsBaseHealthEmployerConcept.EvaluateConcept;
        }
        ...
        public InsBaseHealthEmployerSource SourceValues { get; set; }

        public override void ImportSourceValues(ISourceValues values)
        {
            SourceValues = SetSourceValues<InsBaseHealthEmployerSource>(values);
        }
        ...
        {
            InsBaseHealthEmployerArticle cloneArticle = (InsBaseHealthEmployerArticle)this.MemberwiseClone();
