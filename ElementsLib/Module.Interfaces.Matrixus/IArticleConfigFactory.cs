...
namespace ElementsLib.Module.Interfaces.Matrixus
{
    ...
    public interface IArticleConfigFactory
    {
        ...
        DetailItem CreateDetailItem(IArticleMasterCollection masterStore, DetailCode symbolCode, DetailName symbolName, MasterCode symbolRole, DetailGang symbolGang, DetailType symbolType, DetailBind symbolBind, params DetailCode[] symbolPath);
    }
}
