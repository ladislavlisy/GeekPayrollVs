...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.TaxAdvanceOrdinaryArticle;
    ...
    public static class TaxAdvanceOrdinaryConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "TaxAdvanceOrdinaryConcept(ARTICLE_TAX_ADVANCE_ORDINARY, 1020): {0}";
