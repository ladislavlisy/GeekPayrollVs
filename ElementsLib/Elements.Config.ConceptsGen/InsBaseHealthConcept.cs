...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.InsBaseHealthArticle;
    ...
    public static class InsBaseHealthConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "InsBaseHealthConcept(ARTICLE_INS_BASE_HEALTH, 1035): {0}";
