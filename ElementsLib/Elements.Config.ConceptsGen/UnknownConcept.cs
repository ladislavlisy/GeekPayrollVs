...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.UnknownArticle;
    ...
    public static class UnknownConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "UnknownConcept(ARTICLE_UNKNOWN, 0): {0}";
