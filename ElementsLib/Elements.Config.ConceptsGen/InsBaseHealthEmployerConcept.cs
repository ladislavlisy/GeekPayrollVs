...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.InsBaseHealthEmployerArticle;
    ...
    public static class InsBaseHealthEmployerConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "InsBaseHealthEmployerConcept(ARTICLE_INS_BASE_HEALTH_EMPLOYER, 1037): {0}";
