...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.TaxAdvanceSolidaryArticle;
    ...
    public static class TaxAdvanceSolidaryConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "TaxAdvanceSolidaryConcept(ARTICLE_TAX_ADVANCE_SOLIDARY, 1021): {0}";
