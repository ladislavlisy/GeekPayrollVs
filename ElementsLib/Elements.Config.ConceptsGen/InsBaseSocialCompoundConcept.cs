...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.InsBaseSocialCompoundArticle;
    ...
    public static class InsBaseSocialCompoundConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "InsBaseSocialCompoundConcept(ARTICLE_INS_BASE_SOCIAL_COMPOUND, 1038): {0}";
