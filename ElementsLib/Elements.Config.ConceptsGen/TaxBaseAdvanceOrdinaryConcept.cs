...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.TaxBaseAdvanceOrdinaryArticle;
    ...
    public static class TaxBaseAdvanceOrdinaryConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "TaxBaseAdvanceOrdinaryConcept(ARTICLE_TAX_BASE_ADVANCE_ORDINARY, 1018): {0}";
