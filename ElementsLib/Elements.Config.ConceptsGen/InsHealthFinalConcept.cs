...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.InsHealthFinalArticle;
    ...
    public static class InsHealthFinalConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "InsHealthFinalConcept(ARTICLE_INS_HEALTH_FINAL, 1039): {0}";
