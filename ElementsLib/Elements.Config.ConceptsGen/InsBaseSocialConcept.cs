...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.InsBaseSocialArticle;
    ...
    public static class InsBaseSocialConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "InsBaseSocialConcept(ARTICLE_INS_BASE_SOCIAL, 1037): {0}";
