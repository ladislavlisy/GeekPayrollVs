...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.InsBaseHealthCompoundArticle;
    ...
    public static class InsBaseHealthCompoundConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "InsBaseHealthCompoundConcept(ARTICLE_INS_BASE_HEALTH_COMPOUND, 1035): {0}";
