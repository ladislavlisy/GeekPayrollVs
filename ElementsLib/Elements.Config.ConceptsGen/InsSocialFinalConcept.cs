...
namespace ElementsLib.Elements.Config.Concepts
{
    ...
    using MasterItem = Articles.InsSocialFinalArticle;
    ...
    public static class InsSocialFinalConcept
    {
        public static string CONCEPT_DESCRIPTION_ERROR_FORMAT = "InsSocialFinalConcept(ARTICLE_INS_SOCIAL_FINAL, 1040): {0}";
