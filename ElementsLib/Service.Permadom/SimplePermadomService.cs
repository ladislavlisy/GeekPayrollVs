...
namespace ElementsLib.Service.Permadom
{
    ...
    public class SimplePermadomService : IPermadomService
    {
        ...
        public IEnumerable<ArticleCodeConfigItem> GetArticleCodeData()
        {
            ...
            const TaxingBehaviour TAX_ADVANCE = TaxingBehaviour.TAXING_ADVANCE;
            const TaxingBehaviour TAX_NOTHING = TaxingBehaviour.TAXING_NOTHING;

            return new List<ArticleCodeConfigItem>()
            {
                new ArticleCodeConfigData(0, 0, EARNINGS_GANG, NO_HEAD_PART_TYPE, ARTICLE_OPT, TAX_NOTHING, "FACT_UNKNOWN"),
                new ArticleCodeConfigData(1, 1, EARNINGS_GANG, NO_HEAD_PART_TYPE, ARTICLE_REQ, TAX_NOTHING, "FACT_CONTRACT_TERM"),
                new ArticleCodeConfigData(2, 2, EARNINGS_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_CONTRACT_TIMESHEET", 1, 8),
                new ArticleCodeConfigData(5, 5, EARNINGS_GANG, HEAD_CODE_ARTICLE, ARTICLE_OPT, TAX_NOTHING, "FACT_CONTRACT_ATTEND_ITEM", 2),
                new ArticleCodeConfigData(4, 4, EARNINGS_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_CONTRACT_ABSENCE", 2, 10),
                new ArticleCodeConfigData(3, 3, EARNINGS_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_CONTRACT_WORKING", 2, 9),
                new ArticleCodeConfigData(6, 6, EARNINGS_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_POSITION_TERM", 1),
                new ArticleCodeConfigData(7, 7, EARNINGS_GANG, PART_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_POSITION_SCHEDULE", 6),
                new ArticleCodeConfigData(8, 8, EARNINGS_GANG, PART_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_POSITION_TIMESHEET", 7),
                new ArticleCodeConfigData(10, 10, EARNINGS_GANG, PART_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_POSITION_ABSENCE", 8, 5),
                new ArticleCodeConfigData(9, 9, EARNINGS_GANG, PART_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_POSITION_WORKING", 8, 10),
                new ArticleCodeConfigData(10000, 1000, EARNINGS_GANG, PART_CODE_ARTICLE, ARTICLE_OPT, TAX_ADVANCE, "FACT_POSITION_MONTHLY_AMOUNT", 8, 9),
                new ArticleCodeConfigData(10001, 1001, TRANSFER_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_TAX_DECLARATION"),
                new ArticleCodeConfigData(10002, 1002, TRANSFER_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_INS_HEALTH_DECLARATION"),
                new ArticleCodeConfigData(10003, 1003, TRANSFER_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_INS_SOCIAL_DECLARATION"),
                new ArticleCodeConfigData(10004, 1004, TRANSFER_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_TAX_INCOMES_GENERAL", 10001),
                new ArticleCodeConfigData(10007, 1007, TRANSFER_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_INS_INCOMES_HEALTH", 10002),
                new ArticleCodeConfigData(10008, 1008, TRANSFER_GANG, HEAD_CODE_ARTICLE, ARTICLE_REQ, TAX_NOTHING, "FACT_INS_INCOMES_SOCIAL", 10003),
            };
        }
